                ...
                <div class="d-sm-flex align-items-center mb-3 mb-lg-0 ms-lg-3">
                    <div class="dropdown w-100 w-sm-auto">
                        <a href="#" class="d-flex align-items-center text-body lh-1 dropdown-toggle py-sm-2" data-bs-toggle="dropdown" data-bs-display="static">
                            <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/tesla.svg" class="w-32px h-32px me-2" alt="">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg-end w-100 w-lg-auto wmin-300 wmin-sm-350 pt-0">
                            ...
                            <a href="#" class="dropdown-item py-2">
                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/debijenkorf.svg" class="w-32px h-32px me-2" alt="">
                                <div>
                            ...
                            <a href="#" class="dropdown-item py-2">
                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/klm.svg" class="w-32px h-32px me-2" alt="">
                                <div>
                            ...
                            <a href="#" class="dropdown-item py-2">
                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/shell.svg" class="w-32px h-32px me-2" alt="">
                                <div>
                            ...
                            <a href="#" class="dropdown-item py-2">
                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/bp.svg" class="w-32px h-32px me-2" alt="">
                                <div>
                    ...
                    <div class="d-inline-flex mt-3 mt-sm-0">
                        ...
                        <a href="#" class="status-indicator-container ms-1">
                            <img src="{{ url('public') }}/assets/images/demo/users/face1.jpg" class="w-32px h-32px rounded-pill" alt="">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/facebook.svg" class="rounded-circle" width="36" height="36" alt="">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/youtube.svg" class="rounded-circle" width="36" height="36" alt="">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/spotify.svg" class="rounded-circle" width="36" height="36" alt="">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/twitter.svg" class="rounded-circle" width="36" height="36" alt="">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/bing.svg" class="rounded-circle" width="36" height="36" alt="">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/amazon.svg" class="rounded-circle" width="36" height="36" alt="">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/dribbble.svg" class="rounded-circle" width="36" height="36" alt="">
                                            </a>
                                            <div>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{ url('public') }}/assets/images/demo/users/face15.jpg" class="rounded-circle" width="40" height="40" alt="">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{ url('public') }}/assets/images/demo/users/face3.jpg" class="rounded-circle" width="40" height="40" alt="">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{ url('public') }}/assets/images/demo/users/face8.jpg" class="rounded-circle" width="40" height="40" alt="">
                                            </a>
                                            <div>
                    ...
                    <div class="card-body pb-0">
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="d-sm-flex align-items-sm-start mb-3">
                                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                        <img src="{{ url('public') }}/assets/images/demo/flat/1.png" class="flex-shrink-0 rounded" height="100" alt="">
                                ...
                                <div class="d-sm-flex align-items-sm-start mb-3">
                                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                        <img src="{{ url('public') }}/assets/images/demo/flat/21.png" class="flex-shrink-0 rounded" height="100" alt="">
                                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                            <i class="ph-play"></i>
                                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="d-sm-flex align-items-sm-start mb-3">
                                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                        <img src="{{ url('public') }}/assets/images/demo/flat/12.png" class="flex-shrink-0 rounded" height="100" alt="">
                                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                            <i class="ph-play"></i>
                                        </div>
                                ...
                                <div class="d-sm-flex align-items-sm-start mb-3">
                                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                        <img src="{{ url('public') }}/assets/images/demo/flat/18.png" class="flex-shrink-0 rounded" height="100" alt="">
                                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                            <i class="ph-play"></i>
                                        </div>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/demo/logos/1.svg" alt="" height="36">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/demo/logos/2.svg" alt="" height="36">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/demo/logos/3.svg" alt="" height="36">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/demo/logos/4.svg" alt="" height="36">
                                            </a>
                                            <div>
                ...
                <div class="card">
                    ...
                    <div class="tab-content card-body">
                        <div class="tab-pane active fade show" id="messages-tue">
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ url('public') }}/assets/images/demo/users/face10.jpg" class="rounded-circle" width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-success"></span>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ url('public') }}/assets/images/demo/users/face3.jpg" class="rounded-circle" width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-danger"></span>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ url('public') }}/assets/images/demo/users/face24.jpg" class="rounded-circle" width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-danger"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ url('public') }}/assets/images/demo/users/face4.jpg" class="rounded-circle" width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-danger"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ url('public') }}/assets/images/demo/users/face25.jpg" class="rounded-circle" width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-success"></span>
                                </div>
                        ...
                        <div class="tab-pane fade" id="messages-mon">
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ url('public') }}/assets/images/demo/users/face2.jpg" class="rounded-circle" width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-success"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ url('public') }}/assets/images/demo/users/face7.jpg" class="rounded-circle" width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-warning"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ url('public') }}/assets/images/demo/users/face18.jpg" class="rounded-circle" width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-warning"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ url('public') }}/assets/images/demo/users/face14.jpg" class="rounded-circle" width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-success"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ url('public') }}/assets/images/demo/users/face8.jpg" class="rounded-circle" width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-success"></span>
                                </div>
                        ...
                        <div class="tab-pane fade" id="messages-fri">
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ url('public') }}/assets/images/demo/users/face15.jpg" class="rounded-circle" width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-danger"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ url('public') }}/assets/images/demo/users/face12.jpg" class="rounded-circle" width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-warning"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ url('public') }}/assets/images/demo/users/face22.jpg" class="rounded-circle" width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-danger"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ url('public') }}/assets/images/demo/users/face17.jpg" class="rounded-circle" width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-secondary"></span>
                                </div>
