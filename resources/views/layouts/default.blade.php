...
<!-- Mirrored from themes.kopyov.com/limitless/demo/template/html/layout_1/full/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Sep 2024 10:15:08 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<title>@yield('title','Skyglobals CRM')</title>
	...
	<!-- Theme JS files -->
	<script src="{{ url('public') }}/assets/js/vendor/visualization/d3/d3.min.js"></script>
	<script src="{{ url('public') }}/assets/js/vendor/visualization/d3/d3_tooltip.js"></script>

	<script src="{{ url('public') }}/assets/js/app.js"></script>
	<script src="{{ url('public') }}/assets/demo/pages/dashboard.js"></script>
	<script src="{{ url('public') }}/assets/demo/charts/pages/dashboard/streamgraph.js"></script>
	<script src="{{ url('public') }}/assets/demo/charts/pages/dashboard/sparklines.js"></script>
	<script src="{{ url('public') }}/assets/demo/charts/pages/dashboard/lines.js"></script>	
	<script src="{{ url('public') }}/assets/demo/charts/pages/dashboard/areas.js"></script>
	<script src="{{ url('public') }}/assets/demo/charts/pages/dashboard/donuts.js"></script>
	<script src="{{ url('public') }}/assets/demo/charts/pages/dashboard/bars.js"></script>
	<script src="{{ url('public') }}/assets/demo/charts/pages/dashboard/progress.js"></script>
	<script src="{{ url('public') }}/assets/demo/charts/pages/dashboard/heatmaps.js"></script>
	<script src="{{ url('public') }}/assets/demo/charts/pages/dashboard/pies.js"></script>
	<script src="{{ url('public') }}/assets/demo/charts/pages/dashboard/bullets.js"></script>
	<!-- /theme JS files -->
						...
						<div class="dropdown-menu-scrollable pb-2">
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="{{ url('public') }}/assets/images/demo/users/face10.jpg" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="{{ url('public') }}/assets/images/demo/users/face3.jpg" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="{{ url('public') }}/assets/images/demo/users/face24.jpg" class="w-40px h-40px rounded-pill" alt="">
									<span class="status-indicator bg-success"></span>
								</div>
								<div class="flex-1">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="{{ url('public') }}/assets/images/demo/users/face4.jpg" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="{{ url('public') }}/assets/images/demo/users/face25.jpg" class="w-40px h-40px rounded-pill" alt="">
						...
						<div class="dropdown-menu w-100" data-color-theme="light">
							...
							<div class="dropdown-menu-scrollable-lg">
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img src="{{ url('public') }}/assets/images/demo/users/face3.jpg" class="w-32px h-32px rounded-pill" alt="">
									</div>
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img src="{{ url('public') }}/assets/images/demo/users/face24.jpg" class="w-32px h-32px rounded-pill" alt="">
									</div>
				...
				<li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
					<a href="#" class="navbar-nav-link align-items-center rounded-pill p-1" data-bs-toggle="dropdown">
						<div class="status-indicator-container">
							<img src="{{ url('public') }}/assets/images/demo/users/face11.jpg" class="w-32px h-32px rounded-pill" alt="">
							<span class="status-indicator bg-success"></span>
						</div>
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav-group-sub collapse">
								...
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_2/full/index.html" class="nav-link">Layout 2</a></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_3/full/index.html" class="nav-link">Layout 3</a></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_4/full/index.html" class="nav-link">Layout 4</a></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_5/full/index.html" class="nav-link">Layout 5</a></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_6/full/index.html" class="nav-link">Layout 6</a></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_7/full/index.html" class="nav-link disabled">Layout 7 <span class="badge align-self-center ms-auto">Coming soon</span></a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link">
							...
							<ul class="nav-group-sub collapse">
								...
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/LTR/material/full/index.html" class="nav-link disabled">Material <span class="badge align-self-center ms-auto">Coming soon</span></a></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/LTR/clean/full/index.html" class="nav-link disabled">Clean <span class="badge align-self-center ms-auto">Coming soon</span></a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link">
							...
							<ul class="nav-group-sub collapse">
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_static.html" class="nav-link">Static layout</a></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_no_header.html" class="nav-link">No header</a></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_no_footer.html" class="nav-link">No footer</a></li>
								<li class="nav-item-divider"></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_fixed_header.html" class="nav-link">Fixed header</a></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_fixed_footer.html" class="nav-link">Fixed footer</a></li>
								<li class="nav-item-divider"></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_2_sidebars_1_side.html" class="nav-link">2 sidebars on 1 side</a></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_2_sidebars_2_sides.html" class="nav-link">2 sidebars on 2 sides</a></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_3_sidebars.html" class="nav-link">3 sidebars</a></li>
								<li class="nav-item-divider"></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_boxed_page.html" class="nav-link">Boxed page</a></li>
								<li class="nav-item"><a href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_boxed_content.html" class="nav-link">Boxed content</a></li>
							</ul>
						</li>
						<li class="nav-item">
			...
			<div class="p-3">
				<div class="d-flex align-items-start mb-3">
					<a href="#" class="status-indicator-container me-3">
						<img src="{{ url('public') }}/assets/images/demo/users/face1.jpg" class="w-40px h-40px rounded-pill" alt="">
						<span class="status-indicator bg-success"></span>
					</a>
					<div class="flex-fill">
					...
					<div class="flex-fill">
						...
						<div class="d-flex my-2">
							<a href="#" class="status-indicator-container me-1">
								<img src="{{ url('public') }}/assets/images/demo/users/face10.jpg" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-danger"></span>
							</a>
							<a href="#" class="status-indicator-container me-1">
								<img src="{{ url('public') }}/assets/images/demo/users/face11.jpg" class="w-32px h-32px rounded-pill" alt="">
							...
							<a href="#" class="status-indicator-container me-1">
								<img src="{{ url('public') }}/assets/images/demo/users/face12.jpg" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-success"></span>
							</a>
							<a href="#" class="status-indicator-container me-1">
								<img src="{{ url('public') }}/assets/images/demo/users/face13.jpg" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-success"></span>
							</a>
...
<!-- Mirrored from themes.kopyov.com/limitless/demo/template/html/layout_1/full/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Sep 2024 10:16:44 GMT -->
</html>